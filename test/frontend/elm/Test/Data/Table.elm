...
import Data.Table exposing (globalDecoder, rammarketDecoder, rowsDecoder)
import Expect
...
tests =
    describe "decoders"
        (let
            ...
            expectedRammarketTableRow =
                Data.Table.Rammarket
